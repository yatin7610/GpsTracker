...
public class ResultsActivity extends ActionBarActivity
{
	protected void onCreate(Bundle savedInstanceState)
	{
	    ...
	    if (bundle != null)
	    {
			...
			ArrayList<String>	waitinglist = bundle.getStringArrayList("waitinglist");
			...
			total.addView(createTextView(bundle.getString("waitingtime"), params));
	        total.addView(createTextView(Float.toString(bundle.getFloat("totalSpeed")), params));
	        total.addView(createTextView("", params));
			TableRow totalfare= new TableRow(this);
			totalfare.addView(createTextView("Total Fare",params));
			totalfare.addView(createTextView(String.valueOf(fare),params));
	        tableLayout.addView(total, params);
			tableLayout.addView(totalfare,params);
